...
const InputImageModal = forwardRef<HTMLButtonElement, InputImageModalProps>(
  ({ selectedFiles, setSelectedFiles, multipleImages }, ref) => {
...
InputImageModal.displayName = "InputImageModal";
