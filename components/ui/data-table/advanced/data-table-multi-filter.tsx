...
export function MultiFilterRow<TData>({
  ...
  }, [debounceValue, filterVariety, selectedOption?.value, pathname, router, searchParams]);
  ...
  React.useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [operator?.value, pathname, router, searchParams]);
...
const createQueryString = (params: Record<string, string | number | null>, searchParams: URLSearchParams) => {
