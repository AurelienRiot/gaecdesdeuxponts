...
export const BillingEmail = ({ date, baseUrl, price, id }: BillingEmailProps) => (
	<MainBody baseUrl={baseUrl} previewText="Confirmation du paiement de votre commande - Laiterie du Pont Robert">
...
export const BillingBody = ({ date, price, baseUrl, id }: BillingEmailProps) => (
	<>
