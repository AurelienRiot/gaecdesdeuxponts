  ...
  return (
    <section className="mx-auto mb-10 flex max-w-5xl flex-col gap-4 pt-12 text-lg">
      ...
      <p>
        ...
        société Laiterie du Pont Robert dont le siège social est situé au 6 bis
        le pont robert 44290 MASSERAC, immatriculée au registre du commerce et
        des sociétés de Saint Nazaire sous le numéro SIRET 844 554 147 00018
        ci-après dénommée “ Laiterie du Pont Robert ” et d&apos;autre part, par
        toute personne physique ou morale souhaitant procéder à un achat via le
        site Internet “ laiteriedupontrobert.fr ” dénommée ci-après “
        l&apos;acheteur ”.
      </p>
      <h2 className="text-center text-2xl">Objet</h2>
      <p>
        Les présentes conditions de vente visent à définir les relations
        contractuelles entre Laiterie du Pont Robert et l&apos;acheteur et les
        conditions applicables à tout achat effectué par le biais du site
        marchand de Laiterie du Pont Robert, que l&apos;acheteur soit
        professionnel ou particulier. <br />
        ...
        générales ou particulières non expressément agréées par Laiterie du Pont
        Robert. Laiterie du Pont Robert se réserve de pouvoir modifier ses
        conditions de vente à tout moment. Dans ce cas, les conditions
        applicables seront celles en vigueur à la date de la commande par
        l&apos;acheteur.
      </p>
      ...
      <p>
        Les prix figurant dans le catalogue sont des prix TTC (Toutes Taxes
        Comprises) en euro, le montant en euro correspondant au taux TVA
        applicable est ajouté et indiqué au règlement de la commande; tout
        changement du taux pourra être répercuté sur le prix des produits ou des
        services. <br />
        Laiterie du Pont Robert se réserve le droit de modifier ses prix à tout
        moment, étant toutefois entendu que le prix figurant au catalogue le
        jour de la commande sera le seul applicable à l&apos;acheteur. <br />
      ...
      <p>
        Tous les éléments du site de Laiterie du Pont Robert sont et restent la
        propriété intellectuelle et exclusive de Laiterie du Pont Robert et de
        ses partenaires. <br />
        ...
        accord écrit exprès de Laiterie du Pont Robert.
      </p>{" "}
      ...
      <p>
        ...
        automatisé. <br />
        Laiterie du Pont Robert se réserve le droit de collecter des
        informations sur les acheteurs y compris en utilisant des cookies, et,
        s&apos;il le souhaite, de transmettre à des partenaires commerciaux les
        informations collectées. <br />
        Les acheteurs peuvent s&apos;opposer à la divulgation de leurs
        coordonnées en le signalant à Laiterie du Pont Robert. De même, les
        utilisateurs disposent d&apos;un droit d&apos;accès et de rectification
        des données les concernant, conformément à la loi du 6 janvier 1978.
      </p>
      <h2 className="text-center text-2xl">Archivage - Preuve</h2>
      <p>
        Laiterie du Pont Robert archivera les bons de commandes et les factures
        sur un support fiable et durable constituant une copie fidèle
        conformément aux dispositions de l&apos;article 1348 du Code civil.{" "}
        <br />
        Les registres informatisés de Laiterie du Pont Robert seront considérés
        par les parties comme preuve des communications, commandes, paiements et
      ...
      <p>
        ...
        Saint Nazaire, nonobstant pluralité de défendeurs ou appel en garantie.
      </p>
    </section>
  );
};
