...
import { type OrderColumn, columns, filterableColumns, viewOptionsColumns, searchableColumns } from "./order-column";
...
export const OrderTable: React.FC<OrderTableProps> = ({ data }) => {
  ...
  return (
    <>
      <Heading title={`Commandes (${data.length})`} description="Gérez les commandes" />
