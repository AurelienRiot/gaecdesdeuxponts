        ...
        <div className="grid grid-cols-1 items-center justify-center gap-4 text-center sm:grid-cols-2 ">
          ...
          <div className="space-y-2 text-base lg:text-lg ">
            <p>
              ...
              et de nos animaux. Le lait cru est un produit non pasteurisé qui
              conserve tous ses nutriments et saveurs naturels. Pour assurer une
              qualité irréprochable, nous suivons des pratiques rigoureuses de
              gestion de l’élevage et de la traite.
            </p>
            <p>
              Nos vaches pâturent librement dans des prairies naturelles, ce qui
              leur permet de se nourrir d’herbes fraîches et variées,
              contribuant à un lait riche et savoureux. Nous surveillons
              attentivement leur santé et leur bien-être, garantissant ainsi un
              produit final sain et nutritif.
            </p>
          </div>
          ...
          <div className="space-y-2 text-base lg:text-lg ">
            <p>
              ...
              contamination. Nous utilisons des équipements de traite modernes
              et désinfectés régulièrement pour maintenir des conditions
              d’hygiène optimale.
            </p>
            <p>
              Le lait est ensuite refroidi rapidement après la traite pour
              préserver sa fraîcheur et ses qualités nutritives. Ce lait cru est
              emballé et distribué directement aux consommateurs sans subir de
              traitements thermiques, conservant ainsi tous les enzymes et
              probiotiques bénéfiques qui peuvent être détruits lors de la
              pasteurisation.
            </p>
          </div>
          ...
          <div className=" space-y-2 text-base  lg:text-lg ">
            <p>
              ...
              consommateurs à visiter notre ferme pour découvrir nos méthodes de
              production et rencontrer nos vaches. En achetant notre lait cru
              bio, vous soutenez une agriculture durable et locale, tout en
              profitant d’un produit authentique et savoureux.
            </p>
            <p>
              Nous croyons fermement que le lait cru, lorsqu’il est produit dans
              des conditions rigoureuses et respectueuses, est non seulement
              bénéfique pour la santé, mais aussi pour l’environnement et
              l’économie locale.
            </p>
          </div>
          <Image
