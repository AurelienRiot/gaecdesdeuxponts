				...
				<div className="grid grid-cols-1 items-center justify-center gap-4 text-center sm:grid-cols-2">
					...
					<div className="space-y-2 text-base lg:text-lg">
						...
						<p>
							...
							nutritives. Ce lait cru est emballé et distribué directement aux consommateurs sans subir de traitements
							thermiques, conservant ainsi tous les enzymes et probiotiques bénéfiques qui peuvent être détruits lors de
							la pasteurisation.
						</p>
					</div>
