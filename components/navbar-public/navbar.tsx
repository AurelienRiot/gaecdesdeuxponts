...
const NavBar = async () => {
  ...
  return (
    <div
      className={`fixed top-0 z-30 flex  h-16 w-full items-center justify-between rounded-b-md border   bg-background px-4 shadow-md sm:px-6 lg:px-4 print:hidden`}
    >
